...
public class PostingActivity extends AppCompatActivity implements OnItemClickListener
{
		...
		fb.setOnClickListener(new OnClickListener()
			{
				...
				public void onClick(View p1)
				{
					...
					{
						Toast.makeText(PostingActivity.this,"发帖标题或内容不能为空",Toast.LENGTH_SHORT).show();
					}
